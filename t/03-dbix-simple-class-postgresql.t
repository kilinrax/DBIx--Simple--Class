...
package My::Group; sub PRIMARY_KEY_AUTOGENERATED { 1 }; package main;
...
package My::User; sub PRIMARY_KEY_AUTOGENERATED { 1 }; package main;
...
like(
  (eval { $g2->update }, $@),
  qr/Pg::st execute failed: called with 3 bind/,
...
package My::Collision; sub PRIMARY_KEY_AUTOGENERATED { 1 }; package main;
